...
```{r southern kingfish png 2, fig.cap="Southern kingfish occurrences in the observer database", echo=F,fig.show='hold',fig.pos='H',out.extra='trim={0cm 2.25cm 0cm 1cm},clip',fig.align='center', fig.asp=1}
if(map_figs){
