...
soe.plot(SOE.data.2018, "Time", "chesapeake bay HAB", stacked = NA,status = F,mean = F,
...
polygon(c(doy, rev(doy)),
        ...
        col = "blue", border = NA)
points(doy,ppd_val_LT, type = "l", lwd = .25, "grey90")
...
polygon(c(doy, rev(doy)),
        ...
        col = "blue", border = NA)
points(doy,chl_val_LT, type = "l", lwd = .25, "grey90")
