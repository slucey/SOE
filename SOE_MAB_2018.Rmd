...
```{r managed_landings , fig.cap="Total commercial seafood landings (black), MAFMC managed seafood landings (red)", echo=F, message=FALSE, warning=FALSE , fig.height=2.5, fig.align = 'center'}
...
soe.stacked.axis("Time",expression("Landings, 10"^3*"metric tons"), rel.y.text = 1, rel.x.text=1, outer = F)
```
...
```{r rec_catch_MAB, fig.cap="Total recreational harvest  \\label{recfood}", echo = F, message=F, include=T, warning=F, fig.height=2.5, fig.align = 'center'}
opar <- par(mar = c(4, 6, 2, 6))
...
soe.stacked.axis("Time",expression("Fish caught, 10"^6*" n"),  rel.y.text = 1, rel.x.text=1, outer = F)
