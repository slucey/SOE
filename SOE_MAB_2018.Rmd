...
g1 <- mab.dat %>% filter(cat3 == "A1"|cat3 == "A2"|cat3 == "A3")
g2 <- mab.dat %>% filter(cat3 == "B1"|cat3 == "B2")
g3 <- mab.dat %>% filter(cat3 == "C1")


g2_big <- mab.dat %>% filter(cat3 == "B3")
g3_big <- mab.dat %>% filter(cat3 == "C3"|cat3 == "C2")
...
plot(g3_big, pch = 16, col = c("red","black"),cex = 2,add = T)
