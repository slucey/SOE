...
#NEED TO PULL OTHER PACKAGES UP TO HERE - REVIEW WHAT PACKAGES ARE NECESSARY
...
soe.stacked.axis("Year", expression("Landings, 10"^3*"metric tons"), x.line = 2.7, outer = T)
...
soe.plot(SOE.data.2018, "Time", "Total Landings MAB", rel.y.num = 1.1, 
         scale.axis = 10^3, end.start = 2007, x.start = 1986,
         ymin = FALSE, y.lower = 0 , extra = TRUE, x.var2 = "Time", 
         y.var2 = "Total managed landings MAB", x.label = 'Year',
...
soe.stacked.axis("Time",expression("Fish caught, 10"^6*" n"), rel.x.text = 1, rel.y.text = 1, outer = F)
...
soe.stacked.axis("Time",expression("Revenue, 10"^6*'USD'), outer = F, rel.x.text = 1, rel.y.text = 1)
```
...
soe.plot(SOE.data.2018,"Time","Mid-Atlantic fleet count", stacked = "B",
         endshade = T, rel.y.num = 1.1, full.trend = F, status = F,end.start = 2007)
soe.stacked.axis('Year', 'Commercial fleet diversity', rel.x.text = 1, rel.y.text = 1)
```
...
soe.stacked.axis("Year","Shannon Index", outer = F, rel.x.text = 1, rel.y.text = 1)
```
...
soe.plot(SOE.data.2018,"Time","Mid-Atlantic angler trips", stacked = "B",
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6, status = F,end.start = 2007)
soe.stacked.axis('Year', expression('Recreational Participation, 10'^6*'n'), rel.x.text = 1, rel.y.text = 1)
```
...
soe.plot(SOE.data.2018, "Time", "chesapeake bay HAB", stacked = NA,status = F,mean_line = F,
         ...
         mean_line.2 = F)
soe.stacked.axis("Time","Algal Bloom Events, n", outer = F, rel.x.text = 1, rel.y.text = 1)
```
...
soe.plot(SOE.data.2018, 'Time', "Harbor porpoise bycatch estimates",            
         ...
         end.start = 2007, suppressAxis = F, full.trend = F, point.cex = 1,ymax = F, y.upper = 2500, mean_line = F)
soe.stacked.axis('Year', expression('Harbor Porpoise Bycatch, n'), outer = F, rel.x.text = 1, rel.y.text = 1)
...
soe.stacked.axis('Year', expression('Median Right Whale Abundance, n'), outer = F, rel.x.text = 1, rel.y.text = 1)
...
```{r southern kingfish, fig.cap="Southern kingfish occurrences in the observer database", echo=F, message=FALSE, warning=FALSE ,fig.align='center', fig.height=5, fig.width=6}
if(map_figs){
...
soe.stacked.axis("Time",expression(paste("Mean SST (",degree,"C)")), outer = F, rel.x.text = 1, rel.y.text = 1)
...
soe.plot(SOE.data.2018, "Time", "Centropages typicus abundance anomaly MAB", anomaly = T,
