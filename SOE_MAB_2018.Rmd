...
## Bennet Indicators
Need to add the species group breakdowns for a 3 part fig

=======
## Bennet Indicators & Revenue
>>>>>>> b8ecdb3233cf7d8f61377e1b58ef9bb812121263
...
## Commercial engagement and vulnerability (MAB)
...
## Trends in along shelf distance and depth
from current conditions, by MAFMC managed species

## Modeled shelf habitat area for black sea bass (A: Spring, B: Fall) and summer flounder (C: Spring, D: Fall)
```{r species_distributions_MAB, echo = F, warning = F, include = T,out.width='1\\linewidth', fig.width=5.5, fig.height=8, fig.align='center'}
=======
...
```{r long_term_sst, echo = F, message=F, include=T, warning=F, fig.width=7.5, fig.height=4.5}
opar<-par(mar = c(4, 6, 2, 6))
...
```{r mean_sst_MAB, echo = F, message=F, include=T, warning=F, fig.width=7.5, fig.height=4.5}
opar<-par(mar = c(4, 6, 2, 6))
