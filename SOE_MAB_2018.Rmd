...
th_plot <- function(data, species, letter, z.max, y.axis = T,
                    legend = T, pos){
  if (pos == 'topleft'){
...
par(mfg=c(1,2))
th_plot(data = file.path(gis.dir, "Black Sea Bassfall_2.nc"), species = "sea scallop",
        letter = "B", z.max = 1.353462, y.axis = T, legend = F, pos = "topleft")
par(mfg=c(1,3))
th_plot(data = file.path(gis.dir, "Black Sea Bassfall_4.nc"), species = "sea scallop",
        letter = "C", z.max = 1.353462, y.axis = T, legend = T, pos = "topright")


par(mfg=c(2,2))
th_plot(data = file.path(gis.dir, "Summer Flounderfall_2.nc"), species = "sea scallop",
        letter = "E", z.max = 2.5, y.axis = T, legend = F, pos = "bottomleft")
par(mfg = c(2,3))
th_plot(data = file.path(gis.dir,"Summer Flounderfall_4.nc"), species = "sea scallop",
