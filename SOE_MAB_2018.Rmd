...
## Commercial Landings (A: Apex Predator, B: Piscivore, C: Planktivore, D: Benthivore, E: Benthos)
...
## Total landings of managed species (A) and ecosystem-wide landings (B)

```{r managed_landings , echo = F, warning = F, include = T,out.width='1\\linewidth', fig.width=6.5, fig.height=6, fig.align='center'}

opar <- par(mfrow = c(2, 1), mar = c(0, 0, 0, 0), oma = c(5,6.5,4,1))

soe.plot(SOE.data.2018, "Time", "Total managed landings MAB", stacked = "A",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007)
soe.plot(SOE.data.2018, "Time", "Total Landings MAB", stacked = "B",status  = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3,end.start = 2007)
soe.stacked.axis("Time",expression("Landings 10"^3*" metric tons"), outer = T)
...
## Total revenue of managed species (A) and ecosystem-wide landings (B)

```{r managed_revenue , echo = F, warning = F, include = T,out.width='1\\linewidth', fig.width=6.5, fig.height=6, fig.align='center'}

opar <- par(mfrow = c(2, 1), mar = c(0, 0, 0, 0), oma = c(5,6.5,4,1))

soe.plot(SOE.data.2018, "Time", "Total managed revenue MAB", stacked = "A",status = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6,end.start = 2007)
soe.plot(SOE.data.2018, "Time", "Total Revenue MAB", stacked = "B",status  = F,
         endshade = T, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6,end.start = 2007)
soe.stacked.axis("Time",expression("Revenue 10"^6*" USD"), outer = T)
