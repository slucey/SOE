...
- Outline next steps to follow up on the Mid-Atlantic Council’s initial EAFM risk assessment. 
...
- Modified existing Mid-Atlantic conceptual model using the risk assessment results to consider all key factors affecting black sea bass and its fisheries. 
...
- In the Council EAFM framework, specifying a conceptual model in turn provides the initial scoping for more in-depth management strategy evaluation (MSE)
    ...
    - MSE undertaken by the Council will be a deliberative process and will include stakeholder and Council engagement/involvement. 
...
- Possible desision points
    - Qualitative or quantitative prioritization?
    - Weighted or unweighted? (first priority risks plus tie breakers)
    - How to link to research priorities?

<!--If we get this all done

- Do the conceptual model!
- Do the MSE!
- all by 4 pm!-->
