...
- Don't be intimidated!
    ...
    - Incorporate the knowledge of 
        ...
        - scientsts
        - other stakeholders 
- Goal is to specifically address high-risk factors. Links thoughout the system remain to account for feedbacks or unexpected side effects.
...
- Possible desision points
    ...
    - If possible, recommend prioritization process and the species, fishery or element for further development.
