...
th_plot <- function(data, letter, z.max, y.axis = T,
  ...
  contour(th,drawlabels = F,nlevels = 2,add=T, col = "gray",lty=2, lwd = .9)
...
```{r managed_revenue_NE , fig.cap="Total revenue by region and MAFMC managed species\\label{totcommrev}.", echo=F, message=FALSE, warning=FALSE , fig.asp = 0.5, fig.align = 'center',fig.pos='H'}
opar <- par(mfrow = c(2, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
