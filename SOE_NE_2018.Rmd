...
**We also report single-species status relative to established objectives and reference points**. The New England Council (NEFMC) is meeting objectives at the managed species level for fishing mortality (F) rates and biomass (B) levels for 21 of 38 stocks relative to established reference points (Fig. \ref{KOBE}; note that barndoor, clearnose, little, rosette, smooth, and winter skate stocks have good B and F status according to index based methods, but fishing mortality rates cannot be calculated). The exceptions include high F rates and low B status for GOM cod, Southern New England and Cape Cod/GOM yellowtail flounders, low B status for thorny skates, Atlantic wolfish, ocean pout, Southern New England winter and Northern windowpane flounders, likely low B status for GB Atlantic cod, halibut, and witch flounder, and unknown status for 13 stocks.
...
NE.overfished <- sppcodes[c(17,19,35,44)] # GB cod, halibut, witch, thorny skate
NE.unknown <- sppcodes[c(14,23,33,37,47,48)] #Red deepsea crab,  Offshore hake, GOM winter flounder, GB YT,2 monkfish, 7 skates unknown
my.col[50] <- NE.col
...
plot(NEBO$Brat,NEBO$Frat,xlim=x.r,ylim=y.r,xlab="B/Bmsy",ylab="F/Fmsy",pch=16,col=my.col[12:49])
   ...
   legend('right',legend=NE.unknown,pch=NA,text.col=my.col[c(14,23,33,37,47,48,50)],title="Unknown Status", title.col = "black",bty="n")
...
```{r SST_PPD_CHL_GB, fig.cap="SST (A), primary production (B), and Chl a (C) over 2017 (colored polygons) compared against long-term mean (black line) and +/- 1 standard deviation (grey polygon) in Georges Bank \\label{tempPPGB}",echo = F, fig.show='hold', fig.align='default',warning = F, message = F,fig.pos='H',fig.height = 2.75,fig.width = 8}
## SST
par(mar = c(4, 4, 2, 1), mfrow = c(1,3))
...
Spatial patterns in primary production and chlorophyll fpr 2017 are shown as difference from the long term mean (Fig. \ref{ppchlanom}). 
...
filled in after internal and SSC review
