...
**We also report single-species status relative to established objectives and reference points**. The New England Council (NEFMC) is meeting objectives at the managed species level for fishing mortality (F) rates and biomass (B) levels for 15 of 38 stocks relative to established reference points (Fig. \ref{KOBE}). The exceptions include high F rates and low B status for GOM cod, Southern New England and Cape Cod/GOM yellowtail flounders, low B status for Atlantic wolfish, ocean pout, Southern New England winter and Northern windowpane flounders, likely low B status for GB Atlantic cod, halibut, and witch flounder, and unknown status for 13 stocks.
...
NE.overfished <- sppcodes[c(17,19,35)] # GB cod, halibut, witch
NE.unknown <- sppcodes[c(14,23,33,37,47,48,50)] #Red deepsea crab,  Offshore hake, GOM winter flounder, GB YT,2 monkfish, 7 skates unknown
my.col[50] <- NE.col
