...
The Council selected a range of risk elements to be evaluated at either the managed species level (most), the fleet level (some), or the ecosystem level (few). An overview of the risk elements with definitions and associated indicators as selected by the Council’s Ecosystem and Ocean Planning (EOP) Committee and Advisors is presented below, followed by a summary of risk rankings. A full description of the assessment and indicators is in an accompanying document. 
...
risk.species<-data.frame(
  ...
  FoodWeb1 = c("l", "l", "lm", "l", "l", "l", "l", "lm", "lm", "l", "l", "l", "l", "l", "lm", "l"),
  FoodWeb2 = c("l", "l", "l", "l", "l", "l", "l", "lm", "lm", "l", "l", "l", "l", "l", "lm", "l"),
#  EcoProd = c("lm","lm","lm","lm","lm","lm","lm","lm","lm","lm","lm","lm","lm","lm", "lm", "lm"),
  ...
  OffHabitat = c("na", "na", "na", "na", "na", "na", "na", "na", "na", "na", "na", "na", "na", "na", "na", "na")#,
#  CommProf = c(),
#  RecVal = c(),
#  FishRes1 = c(),
#  FishRes4 = c(),
...
risk.sppsector<-data.frame(
  ...
  RegComplex = c(1,1,4,3,3,3,4,3,1,4,4,4,2,1,1,1,1,1,2,1,3,9,9),
  Discards = c(1,1,4,2,3,3,3,2,1,2,3,4,1,1,1,1,1,3,2,1,2,9,2),
  Allocation = c(1,1,4,4,1,1,4,4,2,2,1,1,1,9,1,1,1,3,3,1,2,9,9) 
)
