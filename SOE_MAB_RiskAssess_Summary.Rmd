...
*highlight the main point is to be on the same page about what risks are of concern* *not set in stone, illustration*
...
risk.sppsector %>%
     mutate_all(replace(., c(1,2,3,4,-9), c("na", "l", "lm", "mh", "h"))) %>%
     as.data.frame()
