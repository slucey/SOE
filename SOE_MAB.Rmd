...
```{r Mariculture, fig.cap="Aquaculture stats from VA. A - hard clams, B - oysters \\label{mariculture}", echo = F, out.width='.45\\linewidth', fig.show='hold'}
