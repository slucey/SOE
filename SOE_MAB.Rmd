...
```{r Mariculture, fig.cap="Aquaculture stats from VA. A - hard clams, B - oysters \\label{mariculture}", echo = F, out.width='.9\\linewidth'}
...
```{r, fig.cap="Energy content of capelin\\label{energy}", echo = F}
