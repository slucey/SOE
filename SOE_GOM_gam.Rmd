---
title: "State of the Ecosystem - Gulf of Maine"
...
```{r, fig.cap="Gulf of Maine Ecosystem \\label{conceptual}", echo = F, out.width = "600pt", fig.align='center'}
knitr::include_graphics(file.path(image.dir, 'GOM_2.png'))
...
opar <- par(mar = c(4, 6, 2, 6))
soe.plot(SOE.data, 'Time', 'Stratification (0-50m) GOM core', x.label = 'Year', rel.y.num = 1.2, rel.y.text = 1,
