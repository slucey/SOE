...
soe.plot(SOE.data.2018, "Time", "Benthos Landings MAB", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Planktivore Landings MAB", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Benthivore Landings MAB", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Piscivore Landings MAB", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Apex Predator Landings MAB", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Total Landings MAB", stacked = "F",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
...
soe.plot(SOE.data.2018, "Time", "Benthos Revenue MAB", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Planktivore Revenue MAB", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Benthivore Revenue MAB", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Piscivore Revenue MAB", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Apex Predator Revenue MAB", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Total Revenue MAB", stacked = "F",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
...
soe.plot(SOE.data.2018, "Time", "Benthos Landings GB", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Planktivore Landings GB", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Benthivore Landings GB", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Piscivore Landings GB", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Apex Predator Landings GB", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Total Landings GB", stacked = "F",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.stacked.axis("Time",expression("Landings 10"^3*" metric tons"), outer = T)
...
soe.plot(SOE.data.2018, "Time", "Benthos Revenue GB", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Planktivore Revenue GB", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Benthivore Revenue GB", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Piscivore Revenue GB", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Apex Predator Revenue GB", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Total Revenue GB", stacked = "F",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.stacked.axis("Time",expression("Revenue 10"^6*" USD"), outer = T)
```
...
soe.plot(SOE.data.2018, "Time", "Benthos Landings GOM", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Planktivore Landings GOM", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Benthivore Landings GOM", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Piscivore Landings GOM", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Apex Predator Landings GOM", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.plot(SOE.data.2018, "Time", "Total Landings GOM", stacked = "F",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^3)
soe.stacked.axis("Time",expression("Landings 10"^3*" metric tons"), outer = T)
...
soe.plot(SOE.data.2018, "Time", "Benthos Revenue GOM", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Planktivore Revenue GOM", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Benthivore Revenue GOM", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Piscivore Revenue GOM", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Apex Predator Revenue GOM", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.plot(SOE.data.2018, "Time", "Total Revenue GOM", stacked = "F",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 10^6)
soe.stacked.axis("Time",expression("Revenue 10"^6*" USD"), outer = T)
```
...
opar <- par(mar = c(4, 6, 2, 6))
soe.plot(SOE.data.2018, "Time", "chesapeake bay HAB", stacked = NA,status = T,
...
soe.plot(SOE.data.2018, "Time", "Benthos Fall Biomass Index MAB", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Planktivore Fall Biomass Index MAB", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Benthivore Fall Biomass Index MAB", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Piscivore Fall Biomass Index MAB", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Total Fall Biomass MAB", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
...
soe.plot(SOE.data.2018, "Time", "Benthos Spring Biomass Index MAB", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Planktivore Spring Biomass Index MAB", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Benthivore Spring Biomass Index MAB", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Piscivore Spring Biomass Index MAB", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Total Spring Biomass MAB", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.stacked.axis("Time",expression("Biomass, kg tow"^-1*''), outer = T)
```
...
soe.plot(SOE.data.2018, "Time", "Benthos Fall Biomass Index GB", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Planktivore Fall Biomass Index GB", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Benthivore Fall Biomass Index GB", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Piscivore Fall Biomass Index GB", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Total Fall Biomass GB", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.stacked.axis("Time",expression("Biomass, kg tow"^-1*''), outer = T)
```
...
soe.plot(SOE.data.2018, "Time", "Benthos Spring Biomass Index GB", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Planktivore Spring Biomass Index GB", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Benthivore Spring Biomass Index GB", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Piscivore Spring Biomass Index GB", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Total Spring Biomass GB", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.stacked.axis("Time",expression("Biomass kg tow"^-1*''), outer = T)
```
...
soe.plot(SOE.data.2018, "Time", "Benthos Fall Biomass Index GOM", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Planktivore Fall Biomass Index GOM", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Benthivore Fall Biomass Index GOM", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Piscivore Fall Biomass Index GOM", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Total Fall Biomass GOM", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.stacked.axis("Time",expression("Biomass, kg tow"^-1*''), outer = T)
```
...
soe.plot(SOE.data.2018, "Time", "Benthos Spring Biomass Index GOM", stacked = "A",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Planktivore Spring Biomass Index GOM", stacked = "B",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Benthivore Spring Biomass Index GOM", stacked = "C",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Piscivore Spring Biomass Index GOM", stacked = "D",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.plot(SOE.data.2018, "Time", "Total Spring Biomass GOM", stacked = "E",status = T,
         endshade = F, rel.y.num = 1.1, full.trend = T, scale.axis = 1)
soe.stacked.axis("Time",expression("Biomass, kg tow"^-1*''), outer = T)
```
...
soe.plot(SOE.data.2018, 'Time', "right_whale_median",            
         scale.axis = 1, rel.y.num = 1.2, stacked = NA, endshade = F,status = T,
...
soe.plot(SOE.data.2018, 'Time', "right whale total males",            
         scale.axis = 1, rel.y.num = 1.2, stacked = "A", status = T, endshade = F,
...
soe.plot(SOE.data.2018, 'Time', "right whale total female",            
         scale.axis = 1, rel.y.num = 1.2, stacked = "B", status = T, endshade = F,
...
soe.plot(SOE.data.2018, 'Time', "Harbor porpoise bycatch estimates",            
         scale.axis = 1, rel.y.num = 1.2, stacked = NA, status = T, endshade = F,
...
opar<-par(mar = c(4, 6, 2, 6))
soe.plot(SOE.data.2018, "Time", "long term SST jan-jun", status = T, endshade = F)
