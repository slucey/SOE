...
```{r PP, fig.cap="Primary production \\label{pp}", echo = F,  fig.height=2}
#,  fig.height=2
...
```{r zoops, fig.cap="A: Centropages typicus spring, B: Centropages typicus fall \\label{Ctyp}", echo = F, fig.height=3}
#, fig.height=3
...
```{r asdist, fig.cap="Shifts in species distribution over time; A: Black sea bass, B: Summer flounder, C: Scup, D: Butterfish, E: Atlantic mackerel, F: Longfin squid, G: Shortfin squid \\label{shifts}", echo = F, message = FALSE, warning = FALSE, fig.height=8}
#, fig.height=8
...
```{r habind, fig.cap="Shifts in modeled species fall habitat area over time; A: Black sea bass, B: Summer flounder, C: Scup, D: Butterfish, E: Atlantic mackerel, F: Longfin squid, G: Shortfin squid, H: Dogfish, I: Goosefish  \\label{shifts}", echo = F, message = FALSE, warning = FALSE, fig.height=9}
#, fig.height=9
#knitr::include_graphics(file.path(image.dir, 'dist-trend_all.png'))
#out.width='\\linewidth'
...
```{r ComProfAgg, fig.cap="Aggregate Mid-Atlantic managed species revenue  \\label{comprofagg}", echo = F, message = FALSE, warning = FALSE, fig.height=2.5}
#, fig.height=2.5
...
```{r RecParticipation, fig.cap="A: number of anglers, B: number of trips \\label{recreation}", echo = F, message = FALSE, warning = FALSE, fig.height=3.5}
#, fig.height=3.5
opar <- par(mfrow = c(2, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
...
```{r revdiv, fig.cap="Diversity in species revenue: A: all species, B: scallops and clams excluded \\label{fleetsppdiv}", echo = F, fig.height=3.5}
#, fig.height=3.5
...
```{r Shoresupp1, fig.cap="Shoreside support businesses: Number of Companies  \\label{shoresupp1}", echo = F, message = FALSE, warning = FALSE, fig.height=2.5}
#, fig.height=2.5
...
```{r Shoresupp2, fig.cap="Shoreside support businesses: Number of Nonemployer entities  \\label{shoresupp2}", echo = F, message = FALSE, warning = FALSE, fig.height=2.5}
#, fig.height=2.5
opar <- par(mfrow = c(1, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
...
```{r FleetDiversitycollapsingthescallopandclamfleets, fig.cap="A: fleet count, B: average fleet diversity  \\label{fleetdiv}", echo = F, fig.height=3.5}
#, fig.height=3.5
load(file.path(data.dir, 'altfleetdiv_data.RData'))
altfleetdiv.data <- altfleetdiv.data[altfleetdiv.data$Time < 2017,]
...
```{r ComFoodAgg, fig.cap="Aggregate Mid-Atlantic managed species landings  \\label{comfoodagg}", echo = F, message = FALSE, warning = FALSE, fig.height=2.5}
#, fig.height=2.5
opar <- par(mfrow = c(1, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 2))
