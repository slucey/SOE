...
*These risk definitions are currently in draft form, pending EOP Committee review. The primary goal of presenting this information is to clearly define and reach agreement about risks of concern to the Council. All risk rankings shown are examples intended for illustration and discussion to be tailored to meet Council needs. This is not a final risk assessment.*
...
| Low-Moderate | Important predator of protected species, important prey of 1-2 protected species, or important prey of 3 or more protected species with management consideration of interaction |
| Moderate-High | Important prey of 3 or more protected species |
| High | Managed species either exclusively dependent on a protected species as prey or is sole prey for a protected species |
"
cat(tabl) # output the table in a format good for HTML/PDF/docx conversion
```
...
```{r PP, fig.cap="Primary production \\label{pp}", echo = F, out.width='0.9\\linewidth', fig.height=2.5}
#,  fig.height=2
...
```{r fishprod, fig.cap="Fish productivity: Anomalies of recruit abundance per spawner biomass for species in the MAB. Annual anomalies shown are the average of spring and fall anomalies. \\label{fishprodsurvey}", echo = F,  out.width='0.7\\linewidth', fig.align='center', message = FALSE, warning = FALSE}
...
```{r NEVAshift, fig.cap="Results of Northeast Climate Vulnerability Analysis (Hare et al. 2016) for Mid-Atlantic species distribution shift risk \\label{NEVAshift}", out.width='\\linewidth'}
...
```{r asdist, fig.cap="Shifts in species distribution over time; A: Black sea bass, B: Summer flounder, C: Scup, D: Butterfish, E: Atlantic mackerel, F: Longfin squid, G: Shortfin squid \\label{shifts}", echo = F, message = FALSE, warning = FALSE, out.width='0.8\\linewidth', fig.height=8}
#, fig.height=8
...
```{r habind, fig.cap="Shifts in modeled species fall habitat area over time; A: Black sea bass, B: Summer flounder, C: Scup, D: Butterfish, E: Atlantic mackerel, F: Longfin squid, G: Shortfin squid, H: Dogfish, I: Goosefish  \\label{shifts}", echo = F, message = FALSE, warning = FALSE, out.width='0.75\\linewidth', fig.height=9}
#, fig.height=9
#knitr::include_graphics(file.path(image.dir, 'dist-trend_all.png'))
#out.width='\\linewidth'
...
```{r ComProfAgg, fig.cap="Aggregate Mid-Atlantic managed species revenue  \\label{comprofagg}", echo = F, message = FALSE, warning = FALSE, out.width='0.9\\linewidth', fig.height=2.5}
#, fig.height=2.5
...
soe.plot(allrev, 'Time', 'MAFMC Revenue', x.label="Year", y.label="Commercial Revenue USD", x.start = 1986, rel.y.num = 0.8, rel.y.text = 1.1)
```
...
```{r RecParticipation, fig.cap="A: number of anglers, B: number of trips \\label{recreation}", echo = F, message = FALSE, warning = FALSE, out.width='0.9\\linewidth', fig.height=3.5}
#, fig.height=3.5
opar <- par(mfrow = c(2, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
...
```{r revdiv, fig.cap="Diversity in species revenue: A: all species, B: scallops and clams excluded \\label{fleetsppdiv}", echo = F, out.width='0.9\\linewidth', fig.height=3.5}
#, fig.height=3.5
...
| Low-Moderate | Increasing or high variability in shoreside support businesses, or long-term decrease in at least one shoreside support businesses |
...
```{r Shoresupp1, fig.cap="Shoreside support businesses: Number of Companies  \\label{shoresupp1}", echo = F, message = FALSE, warning = FALSE, out.width='0.9\\linewidth', fig.height=2.5}
#, fig.height=2.5
...
```{r Shoresupp2, fig.cap="Shoreside support businesses: Number of Nonemployer entities  \\label{shoresupp2}", echo = F, message = FALSE, warning = FALSE, out.width='0.9\\linewidth', fig.height=2.5}
#, fig.height=2.5
opar <- par(mfrow = c(1, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
...
```{r CommJobs, fig.cap="A: New York, B: New Jersey, C: Delaware, D: Maryland, E: Virginia  \\label{commjobs}", echo = F, out.width='0.9\\linewidth', fig.height=5.5}
#, fig.height=5.5
...
```{r RecJobs, fig.cap="A: New York, B: New Jersey, C: Delaware, D: Maryland, E: Virginia  \\label{recjobs}", echo = F, out.width='0.9\\linewidth', fig.height=5.5}
#, fig.height=5.5
opar <- par(mfrow = c(5, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
...
At the request of the EOP and advisors, the diversity metrics were also calculated defining scallop landings as a single fleet and clam/quahog dredges as a single fleet. However, the overall trends are very similar. 

```{r FleetDiversitycollapsingthescallopandclamfleets, fig.cap="A: fleet count, B: average fleet diversity  \\label{fleetdiv}", echo = F, out.width='0.9\\linewidth', fig.height=3.5}
#, fig.height=3.5
load(file.path(data.dir, 'altfleetdiv_data.RData'))
altfleetdiv.data <- altfleetdiv.data[altfleetdiv.data$Time < 2017,]
...
```{r ComFoodAgg, fig.cap="Aggregate Mid-Atlantic managed species landings  \\label{comfoodagg}", echo = F, message = FALSE, warning = FALSE, out.width='0.9\\linewidth', fig.height=2.5}
#, fig.height=2.5
opar <- par(mfrow = c(1, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 2))
...
| High | High overlap; other ocean uses could seriously disrupt fishery prosecution; major permanent habitat impacts |
"
cat(tabl) # output the table in a format good for HTML/PDF/docx conversion
```
