...
| Low-Moderate | Important predator or prey of other managed species, but management considers interaction |
| Moderate-High | Important predator or prey of other managed species, interaction not considered |
...
| Low-Moderate | Important predator or prey of protected species, but management considers interaction |
| Moderate-High | Important predator or prey of protected species, interaction not considered |
...
This element is applied at the species level. Changes (particularly reduction) in diversity at the species/stock level (size, sex, reproductive). *Needs data workup by species, may not be done by Oct*
...
Species distribution on the NE Shelf can be characterized by the position in the ecosystem along an axis oriented from the southwest to the northeast, referred to as the along shelf distance, and by depth. Along shelf distances range from 0 to 1360, which relates to positions along the axis from the origin in the southwest to the northeast in kilometer units. The mean along shelf distance for several MAFMC species by year is shown below; most are consistent with the predictions of NEVA and show a northeastward change in distribution aside from shortfin squid.  Therefore, shortfin squid, which was not included in NEVA, is ranked low risk for distribution shifts. Mean depth has not changed significantly for these species. Information for more species is available at http://www.nefsc.noaa.gov/ecosys/current-conditions/species-dist.html. 
...
##Estuarine Habitat
This element is applied at the species level. Risk of not achieving OY due to threats to estuarine habitat/nursery grounds was determined by first evaluating the estuarine dependence of species, and then by enumerating threats to the estuarine habitat required by these species. Water and habitat quality assessments produced for Cheseapeake Bay, Delaware Bay, Long Island Sound and other coastal estuaries can be considered. *will see how much I can get done by October to make this happen instead of our former is/is not dependent on estuaries ranking*
...
As a start, the US EPA National Coastal Condition Assessment for the Northeast US [@waters_national_2012] was used to evaluate estuarine condition. This report lists water, sediment, benthic, and coastal habitat quality as well as fish contamination. Northeast US coastal waters in the Mid-Atlantic region rated fair to poor for water quality, fair for sediment quality, poor for benthic quality, good to fair for coastal habiat, and fair to poor for fish contamination. These ratings were based on nearshore and estuarine summer sampling 2003-2006. The overall coastal condition was rated fair for the entire region, but this includes offshore conditions which we address in the next element. Therefore, estuarine dependent species (summer flounder, scup, black sea bass, and bluefish) were ranked high risk based on overall poor estuarine condition for this element, and all others were ranked low risk due to minimal estuarine dependence. 

##Offshore Habitat
This element is applied at the species level. The risk of achieving OY due to changes in offshore habitat quality and quantity was assessed using trends in thermal habitat and species-specific habitat modeling. *work in progress, need to get from Kevin Friedland*
...
| Risk Level         | Definition                                                          |  
|:-------------------|:--------------------------------------------------------------------|
| Low  | No trend in revenue |
| Low-Moderate | Significant long term revenue decrease |
...
This element is applied at the ecosystem level. This element addresses the risk of reduced commercial fishery business resilience by evaluating three indicators of fleet diveristy, including the number of distinct fleets, diversity of revenue across fleets, and species diversity of revenue. 

```{r riskfrel1, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Risk Level         | Definition                                                          |  
|:-------------------|:--------------------------------------------------------------------|
| Low  | No trend in any diversity measure |
| Low-Moderate | Significant long term decrease in 1 diversity measure |
| Moderate-High | Significant long term decrease in 2+ diversity measures |
| High | Significant recent decrease in 2+ diversity measures |
"
cat(tabl) # output the table in a format good for HTML/PDF/docx conversion
```
...
Because more than 2 of these indices show a significant long term decrease, there is moderate-high risk to fishery resilience based on diversity. 
...
| Low-Moderate | Significant long term decrease in access to capital |
...
| Low-Moderate | Significant long term decrease in insurance availability |
...
| Low-Moderate | Significant long term decrease in shoreside support businesses |
...
| Low-Moderate | Significant long term decrease in employment |
...
##Social-Cultural
This element is applied at the *??* level. This element ranks the risk to maintaining human coastal community resilience. *Element needs clarification--not sure which indicators to use but we do have community level vulnerability indicators, could be aggregated to regional level* 

```{r risksoc, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Risk Level         | Definition                                                          |  
|:-------------------|:--------------------------------------------------------------------|
| Low  | No trend in community indices |
| Low-Moderate | Significant long term trend in community indices |
...
| Low-Moderate | Significant long term decrease in seafood landings |
...
| Low-Moderate | Significant long term decrease in recreational landings |
...
##Interactions
This element is applied at the species level. This element addresses the risk of not achieving OY due to interactions with non-MAFMC managed species, including protected species. *THIS COULD BE: dependence on outside managed species ecologically, or caught together with outside managed species/fleet primarily regulated by outside agency, or ruled by the bycatch of a protected species* 
...
| Low-Moderate | Important predator or prey on non-MAFMC managed species |
...
##Other Ocean Uses
This element is applied at the *??* level. This element addresses the risk of fishery displacement *(or damage of a fishery resource/habitat?)* Do historical fishing areas overlap with energy development/sand mining/other industrial locations?
