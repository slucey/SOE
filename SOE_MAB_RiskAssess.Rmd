...
soe.plot(SOE.data, 'Time', 'BLACK SEA BASS Habitat Index Fall',    stacked = 'A', scale.axis = 100, 
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'SUMMER FLOUNDER Habitat Index Fall',   stacked = 'B', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'SCUP Habitat Index Fall',              stacked = 'C', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'BUTTERFISH Habitat Index Fall',        stacked = 'D', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'ATLANTIC MACKEREL Habitat Index Fall', stacked = 'E', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'LONGFIN SQUID Habitat Index Fall',     stacked = 'F', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'NORTHERN SHORTFIN SQUID Habitat Index Fall', stacked = 'G', 
         scale.axis = 100, rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'SPINY DOGFISH Habitat Index Fall', stacked = 'H', 
         scale.axis = 100, rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'GOOSEFISH Habitat Index Fall', stacked = 'I', 
         scale.axis = 100, rel.y.num = 0.9)
...
soe.plot(SOE.data, 'Time', 'BLACK SEA BASS Habitat Index Spring',    stacked = 'A', scale.axis = 100, 
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'SUMMER FLOUNDER Habitat Index Spring',   stacked = 'B', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'SCUP Habitat Index Spring',              stacked = 'C', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'BUTTERFISH Habitat Index Spring',        stacked = 'D', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'ATLANTIC MACKEREL Habitat Index Spring', stacked = 'E', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'LONGFIN SQUID Habitat Index Spring',     stacked = 'F', scale.axis = 100,
         rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'NORTHERN SHORTFIN SQUID Habitat Index Spring', stacked = 'G', 
         scale.axis = 100, rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'SPINY DOGFISH Habitat Index Spring', stacked = 'H', 
         scale.axis = 100, rel.y.num = 0.9)
soe.plot(SOE.data, 'Time', 'GOOSEFISH Habitat Index Spring', stacked = 'I', 
         scale.axis = 100, rel.y.num = 0.9)
...
```
-->
*This experimental habitat index is still being studied and improved, so no habitat risk rankings will be based on it at this time. This research is ongoing such tnat rankings may be possible in the near future.* 
...
Because this index show a significant long term decrease, there is moderate-high risk to fishery business resilience based on diversity in species revenue. 
