...
| Allocation  | Risk of this taking up all the Council's time      | Expert judgement |
"
...
##Offshore Habitat
This element is applied at the species level. The risk of achieving OY due to changes in offshore habitat quality and quantity was assessed using species-specific habitat modeling. *work in progress, need to get from Kevin Friedland*
...
| Low-Moderate | Significant long term change (increase or decrease) in habitat quality or quantity |
...
```{r risktemp, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Risk Level         | Definition                                                          |  
|:-------------------|:--------------------------------------------------------------------|
| Low  |  |
