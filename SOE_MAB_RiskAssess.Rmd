...
This is commercial revenue, aggregated for MAFMC managed species. There is a long term increase in revenue, but a recent significant decrease in revenue, indicating high risk to commercial fishery profit.
...
These significant recent decreases in numbers of anglers and numbers of trips alone suggest high risk to recreational value for the species subject to recreational fisheries (summer flounder, scup, black sea bass, bluefish). 
...
The number of shoreside support businesses were tallied for all Mid-Atlantic states in two categories: number of companies and number of non-employer entities, which we consider separately. Some state level data was not included due to confidentiality. 
...
This element is applied at the state level. This element ranks the risk of not optimizing employment opportunities in the commercial sector. Risks were assessed by examining time series of employment information from Fisheries of the U.S. [@lowther_fisheries_2015]. 
...
#kable(creltab.p, digits=2, format = "latex", booktabs = T, caption="Proportion of communities at each level of commercial reliance") %>%
#  kable_styling (position = "center", "HOLD_position") 

#kable(rreltab.p, digits=2, format = "latex", booktabs = T, caption="Proportion of communities at each level of recreational reliance") %>%
#  kable_styling (position = "center", "HOLD_position")
...
Each species would be evaluated as to the degree of spatial or sector allocation currently specified within the FMP. Expert judgement will be used to evaluate the level of risk of not achieving OY posed by existing allocation relative current states of nature. 
