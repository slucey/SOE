...
##Recreational Value
This element is applied at both the fleet level and at the ecosystem level where it would apply equally to all recreationally fished species. Risk of not maximizing fishery value is evaluated using the number of marine recreational fishing angler-days and number of marine recreational trips, in aggregate.
...
```{r, fig.cap="Diversity in species revenue \\label{fleetsppdiv}", echo = F, fig.height=3.5}
