...
soe.plot(SOE.data, 'Time', 'aquaculture RI total value value', x.label = 'Year', y.label='Total value millions $', scale.axis = 1000000)

opar <- par(mfrow = c(1, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
soe.plot(SOE.data, 'Time', 'aquaculture RI oysters sold', x.label ='Year', y.label='Millions of oysters sold', scale.axis = 1000000)
...
soe.plot(SOE.data, 'Time', 'Stratification (0-50m) GOM core', y.label = "GOM Stratification", tol = 0.01, rel.y.num = 1.1)

soe.plot(SOE.data, 'Time', 'Stratification (0-50m) GB core', y.label = "GB Stratification", tol = 0.01, rel.y.num = 1.1)
