...
```{r, fig.cap="Summary of single species status for NEFMC stocks \\label{KOBE}", echo = F,fig.height=8, fig.width=6, out.width='0.5\\linewidth', message = FALSE, warning = FALSE}
...
```{r Mariculture2, fig.cap="Aquaculture stats from RI: total value (left), oysters sold (right) \\label{mariculture}", echo = F, fig.height=2.5, out.width='.45\\linewidth', fig.show='hold', warning = F}
...
```{r, fig.cap='Gulf of Maine seabirds, number of breeding pairs: A - Common tern, B - Arctic tern \\label{GOMterns}', fig.height=3.5, echo=F}

par <- par(mfrow = c(2, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
soe.plot(SOE.data, 'Time', 'GOM Common tern', stacked = 'A', stacked.ticks = F, tol = 0.03,
         rel.y.num = 1.1, end.start = 2006, scale.axis = 10^3)
soe.plot(SOE.data, 'Time', 'GOM Arctic tern', stacked = 'B', tol = 0.03, 
         rel.y.num = 1.1, end.start = 2006, scale.axis = 10^3)
...
```{r, fig.cap="Energy content of capelin\\label{energy}", echo = F,  fig.height=2.5, out.width='.5\\linewidth'}
...
```{r, fig.cap="Primary production, Gulf of Maine (left) and Georges Bank (right) \\label{pp}", echo = F,  fig.height=2.5, fig.show='hold', out.width='.49\\linewidth'}
opar <- par(mar = c(4, 6, 2, 6))
...
```{r , fig.cap="A: Pseudocalanus spring, B: Pseudocalanus fall, C: Calanus finmarchicus spring, D: Calanus finmarchicus fall \\label{zoopspp}", echo = F, fig.height=5, fig.show='hold', out.width='.49\\linewidth'}
...
```{r, fig.cap="Stratification \\label{Stratification}", echo = F, fig.height=2.5, fig.show='hold', out.width='.49\\linewidth' }
