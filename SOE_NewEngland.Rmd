...
```{r Mariculture2, fig.cap="Aquaculture stats from RI: total value (left), oysters sold (right) \\label{mariculture}", echo = F, fig.height=2.5, out.width='.45\\linewidth', fig.show='hold'}
...
```{r Current Temps, fig.cap="Annual sea surface temperature cycle for Georges Bank (A) and Gulf of Maine (B) in 2016.  Center line is the longterm mean.  Dark red color indicates temperature was above 1 standard deviation of the mean while light red indicates the temperature was above the mean. The grey shaded area is plus or minus 1 standard deviation.\\label{annual cycle}", echo = F, fig.height=2.5, out.width='.45\\linewidth', fig.show='hold'}
#Colors
high.col     <- '#d7191c'
med.high.col <- '#fdae61'
med.low.col  <- '#abdda4'
