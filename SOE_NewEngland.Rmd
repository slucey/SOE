...
soe.plot(SOE.data, 'Time', 'New England average fleet diversity', rel.y.num = 0.8, stacked = 'A')
...
opar <- par(mfrow = c(2, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
soe.plot(SOE.data, 'Time', 'aquaculture ME Atlantic salmon harvest weight', scale.axis = 100000, stacked = 'A')
...
opar <- par(mfrow = c(2, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
soe.plot(SOE.data, 'Time', 'aquaculture ME blue mussels harvest weight', scale.axis = 100000,  stacked = 'C')
