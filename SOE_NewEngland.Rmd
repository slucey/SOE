...
soe.plot(SOE.data, 'Time', 'YELLOWTAIL FLOUNDER ASDIST',    stacked = 'A', scale.axis = 100, 
         rel.y.num = 0.9)
...
soe.plot(SOE.data, 'Time', 'GOM Common tern', stacked = 'A', tol = 0.03,
...
soe.plot(SOE.data, 'Time', 'GOM Pseudocalanus spring', stacked = 'A', tol = 0.03,
...
opar <- par(mfrow = c(4, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
soe.plot(SOE.data, 'Time', 'GB Pseudocalanus spring', stacked = 'A', tol = 0.03,
         rel.y.num = 1.1, scale.axis = 10^3)
...
opar <- par(mfrow = c(3, 1), mar = c(0, 0, 0, 0), oma = c(4, 6, 2, 6))
soe.plot(SOE.data, 'Time', 'GBK Yearly Calanus Anomaly', stacked = 'A', tol = 0.01)
