...
The Council is one of eight regional management councils in the United States, and is responsible for developing and implementing fishery managment plans to meet the objectives of federal fishery legislation. The Council system is a co-managment system where stakeholders are integrated into decision processes through representation by state-appointed Council members as well as by direct participation as advisors and as members of the general public during public Council meetings, held every few months throughout each year. In the Mid-Atlantic, the Council has incorporated stakeholder feedback on its management through a Visioning process (2011-2013). This process identified implementation of ecosystem approaches to fishery management as a high priority across all stakeholder groups. The Council therefore had a series of workshops and developed several white papers between 2014 and 2016 regarding forage fish, climate, habitat, and ecological interactions. At the same time, national policy on EAFM/EBFM was developed and released by the National Oceanic and Atmospheric Administration (NOAA), establishing ecosystem approaches to fishery management as a national priority. 
...
#Methods
Series of publicly accessible meetings in 2016-2017 to develop the risk assessment, combined with existing ecosystem reporting efforts, data, and expert knowledge. The general approach was for Council staff and analysts to develop prototypes after discussion with Council members, advisors, and stakeholders, which the Council committee and then full Council would adjust and refine. This iterative approach allowed the risk assessment to develop fairly quickly to meet management timeframes. 

July 2016: initial meeting with Council Ecosystem and Ocean Planning committee to review prototype risk table by species, 
• August 2017 Council Meeting: Identified draft risk elements for matrix of managed species.
...
As the process evolved, the following definitions were established to clarify each component of the analysis for all involved. 
...
How the indicator is interpreted to evaluate risk = Risk Criteria

A **Risk Element** is an aspect that may threaten achieving the biological, economic, or social objectives that the Council desires from a fishery. By that definition, some risk elements may change as conditions change or new information becomes available. Thus, the Council planned for this EAFM risk assessment to be a dynamic and evolving process that will be revisited and updated in future years.  

**Risk Definition** Risk elements were organized into five categories: Ecological, Economic, Social, Food Production, Management. These categories align roughly with management objectives for US fisheries as specified in an integrated ecosystem assessment context [@depiper_operationalizing_2017].

**Indicator** Therefore, ecosytem indicators had already been identified and presented for many of the general management objectives in the region prior to development of the risk assessment (http://www.mafmc.org/s/Tab02_2017-04_State-of-the-Ecosystem-and-EAFM.pdf). 

**Risk Ranking Criteria** were developed iteratively between analysts and the Council to use the available indicator(s). We note that for many of these there is no established high risk threshold, so the consensus of the Council and committee were used to establish risk levels. If clear thresholds become available for any element/indicator combination, they can be substituted into future assessments. Similarly, if the risk tolerance of the Council changes over time, the ranking criteria can be similarly adjusted. 
