...
#Introduction
Fishery managers worldwide are evaluating methods for incorporating climate, habitat, ecological, social, and economic factors into current operations in order to implement Ecosystem Approaches to Fishery Management (EAFM). While this can seem overwhelming, it is possible to take practical steps towards EAFM implementation that make use of existing information and provide managers with valuable strategic advice. Here, we describe the process used by the U.S. Mid-Atlantic Fishery Management Council (MAFMC) to develop an ecosystem-level risk assessment, the initial step proposed in their recently adopted EAFM policy guidance. 

Council process background in the US. briefly. Stakeholders, co-management. Mid-Atlantic process getting to this point briefly. Visioning, workshops, EAFM white papers, EAFM policy guidance. National policy on EAFM/EBFM. 
