...
**Risk Ranking Criteria** were developed iteratively between analysts and the Council to use the available indicator(s)
...
How is risk evaluated = Risk Criteria

Risk Categories: Ecological, Economic, Social, Food Production, Management. These categories align roughly with management objectives for US fisheries as specified in an integrated ecosystem assessment context [@depiper_operationalizing_2017]. Therefore, ecosytem indicators had already been identified and presented for many of the general management objectives in the region prior to development of the risk assessment (http://www.mafmc.org/s/Tab02_2017-04_State-of-the-Ecosystem-and-EAFM.pdf). 
...
Can always improve. Statistical analysis of time series, indicator selection, all can be updated in future iterations of the risk assessment. 
...
```{r riskel, tab.cap="Risk Elements, Definitions, and Indicators Used\\label{riskel}", echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
