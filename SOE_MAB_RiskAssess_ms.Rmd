...
This element is applied at the species and sector (commercial and recreational) level. This element addresses the level of management control in terms of catch estimation (measurement) and monitoring to prevent overfishing. Adequate management control indicates a low risk of overfishing, while poor management control indicates a higher risk of overfishing and hence not achieving OY. Actual catch is compared with the specified Acceptable Biological Catch (ABC) over the most recent five year history of the fishery. 
<!--
...
###Other ocean uses
This element is applied at the species and sector (commercial and recreational) level. This element addresses the risk of fishery displacement or damage of a fishery resource and/or supporting habitat as a result of non-fishing activities in the ocean (e.g., energy development/sand mining/other industrial uses, etc.). It also includes evaluation of risk to Council fisheries from area-based measures outside of the control of the Council, including area closures implemented by other Councils to protect sensitive habitats, spawning areas, etc. and/or through marine monument or other types of area-based management designations.     
<!--
...
This element can be evaluated through GIS analyses which quantify the degree of overlap ocean uses and/or expert opinion relative impacts on habitat quality and function. In this case, Council staff used expert opinion. Low risk ranking  was defined as no overlap with other ocean activities and/or no impact on habitat. Low-Moderate risk was defined as low-moderate overlap and/or minor habitat impacts but transient. Moderate-High risk were moderate-high overlap and/or minor habitat impacts but persistent. High risk were high overlap where other ocean uses could seriously disrupt fishing and/or result in major permanent habitat impacts.
