...
Low risk for assessment performance was defined as stock assessment model(s) passing peer review, and stocks having high data quality. Low-Moderate risk was assessments passing peer review, but some key data and/or reference points are lacking. The Moderate-High risk category was not used for this element. High risk was the assessments failing peer review, and/or that data-limited tools were applied. 
<!--
...
These elements are applied at the species level. Fishing mortality (F) rates and biomass (B) levels relative to established reference points [@gabriel_review_1999] from assessments indicate the level of risk to achieving OY respectively from either overfishing or stock depletion.
